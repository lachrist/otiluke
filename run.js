...
if ("help" in args)
  console.log([
      ...
      "  --log:        log granularity: [nothing|error|warning|info].",
      ...
      "",
      "otiluke --log warning --namespace  __hidden__ --initialize /path/to/init.js --port 8080",
    ].join("\n"));

var initialize = args.initialize ? require("fs").readFileSync(args.initialize) : null;

(require("./main.js"))(args.log, args.namespace, initialize, args.port);
