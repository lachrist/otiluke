...
module.exports = function (readable, writable, onjs, runtime, otiluke) {
    ...
    readable.pipe(new HtmlParser.Parser({
      onopentag: function(tag, attributes) {
        ...
        if (tag === "script") {
          ...
          writable.write(template.replace(/@OTILUKE/g, otiluke).replace(/@RUNTIME/g, runtime))
          writable.write("</script>")
        }
      },
