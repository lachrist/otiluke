...
// otiluke --test [--parallel] [--mock] --virus path/to/virus.js [--receptor path/to/receptor.js] [--receptor-logger path/to/log.txt] --source path/to/source[.js] [--parameter foo]
...
function isfailure (result) { return result.stderr.length }
function sourceof (result) { return result.source }
...
// spawn, parameter, sources, parallel
